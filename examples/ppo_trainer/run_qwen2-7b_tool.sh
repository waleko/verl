...
#     actor_rollout_ref.model.path=JetBrains-Research/Qwen3-8B-am \
...
#     critic.model.path=JetBrains-Research/Qwen3-8B-am \
...
#     trainer.experiment_name='qwen3-8b_retool' \
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.logger=['console','wandb'] \
    trainer.project_name='verl_retool' \
    trainer.experiment_name='qwen3-8b_function_rm_kl1e-3' \
